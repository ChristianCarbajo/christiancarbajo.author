  ...
  return (
    <div className='writting'>
      ...
      <p>
        ...
        tengo escrito mucha historia de las razas más nombradas en el libro. Mi intención no es hacer un Silmarillon, ni nada por el estilo, pero necesito
        organizar cada cosa para que cuando aparezca en la novela, no se me vaya la olla y empiece a poner cosas inconexas. Esto puede pasarme porque
        no tengo un guión como tal, es decir, que voy improvisando constantemente todo. Una vez tengo bastante escrito, después de leerlo, se me van ocurriendo
        tramas o subtramas, pero nunca sé con exactitud que va a pasar. Hay momentos que mientras estoy escribiendo me voy sorprendiendo de lo que está
        pasando. 
      </p>
      <p>
      ...
      <p>
        Iré poniendo los avances de la misma en mis redes sociales, las cuales tenéis arriba de la página. Os pondré descripciones de la razas, 
        los planetas, o lo que se me vaya ocurriendo. Siempre podemos comentarlo y disfrutar de la creación todos juntos.
      </p>
